...
if(UNIX AND NOT APPLE AND NOT CYGWIN)
    ...
    set(HIP_LIBRARIES)
    list(APPEND HIP_LIBRARIES "/opt/rocm/hip/lib/libhip_hcc_static.a")
    list(APPEND HIP_LIBRARIES "/opt/rocm/hip/lib/libhip_device.a")
    list(APPEND HIP_LIBRARIES "/opt/rocm/hip/lib/libhip_hcc.so")
    list(APPEND HIP_LIBRARIES "/opt/rocm/lib/libhc_am.so")
    list(APPEND HIP_LIBRARIES "/opt/rocm/lib/libhsakmt.so")
    list(APPEND HIP_LIBRARIES "/opt/rocm/lib/libhsa-runtime64.so")
    list(APPEND HIP_LIBRARIES "-lpthread")
endif()
...
macro(HIP_PREPARE_TARGET_COMMANDS _target _format _generated_files _source_files)
    ...
    list(APPEND _hip_include_directories "$<TARGET_PROPERTY:${_target},INCLUDE_DIRECTORIES>")
    ...
    #    endforeach()
    #endif()
    list(APPEND HIP_HIPCC_INCLUDE_ARGS ${_hip_include_directories})
...
macro(HIP_ADD_EXECUTABLE hip_target)
    ...
    #set(CMAKE_HIP_LINK_EXECUTABLE "hipcc <FLAGS> <CMAKE_CXX_LINK_FLAGS> <LINK_FLAGS> <OBJECTS> -o <TARGET> <LINK_LIBRARIES> ")
    ...
    #target_link_libraries(${hip_target} PUBLIC ${HIP_LIBRARIES})
endmacro()
